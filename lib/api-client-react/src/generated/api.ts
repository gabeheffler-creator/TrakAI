...
/**
 * @summary List exercise cues for a client (coach and client)
 */
...
export const getListExerciseCuesQueryKey = (clientId: number,) => {
    return [
    `/api/clients/${clientId}/exercise-cues`
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListExerciseCuesQueryKey(clientId);
   ...
   return  { queryKey, queryFn, enabled: !!(clientId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listExerciseCues>>, TError, TData> & { queryKey: QueryKey }
}
...
/**
 * @summary Create an exercise cue for a client (coach only)
 */
export const createExerciseCue = async (clientId: number,
    exerciseCueInput: ExerciseCueInput, options?: RequestInit): Promise<ExerciseCue> => {
...
export const getCreateExerciseCueMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateExerciseCueMutationError = ErrorType<void>

    /**
 * @summary Create an exercise cue for a client (coach only)
 */
export const useCreateExerciseCue = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createExerciseCue>>, TError,{clientId: number;data: BodyType<ExerciseCueInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getDeleteExerciseCueUrl = (clientId: number,
    cueId: number,) => {
...
/**
 * @summary Delete an exercise cue (coach only)
 */
export const deleteExerciseCue = async (clientId: number,
    cueId: number, options?: RequestInit): Promise<void> => {
...
export const getDeleteExerciseCueMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteExerciseCueMutationError = ErrorType<void>

    /**
 * @summary Delete an exercise cue (coach only)
 */
export const useDeleteExerciseCue = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteExerciseCue>>, TError,{clientId: number;cueId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
