...
export const ListExercisesResponseItem = zod.object({
  ...
  "equipment": zod.enum(['Barbell', 'Dumbbell', 'Cable', 'Machine', 'Bodyweight', 'Bands', 'Other']).optional(),
...
export const GenerateAiProgramResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "description": zod.string().nullish(),
  "durationWeeks": zod.number().nullish(),
...
export const CreateProgramPhaseResponse = zod.object({
  "id": zod.number(),
...
export const DeleteProgramPhaseResponse = zod.void()
...
export const DeleteDayNutritionGoalResponse = zod.void()
...
export const CreateProgramDayResponse = zod.object({
  "id": zod.number(),
  "programId": zod.number(),
  "dayNumber": zod.number(),
  "name": zod.string(),
...
export const DeleteProgramDayResponse = zod.void()
...
export const DeleteProgramExerciseResponse = zod.void()
...
export const AssignProgramResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "programId": zod.number(),
  "programName": zod.string(),
...
export const CreateWorkoutLogResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "programDayId": zod.number().nullish(),
  "programDayName": zod.string().nullish(),
...
export const LogMeasurementResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "date": zod.coerce.date(),
  "weight": zod.number().nullish(),
...
export const LogSleepResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "date": zod.coerce.date(),
  "hoursSlept": zod.number(),
...
export const DeleteSleepLogResponse = zod.void()
...
export const CreateNutritionLogResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "date": zod.coerce.date(),
  "imageUrl": zod.string(),
...
export const DeleteNutritionLogResponse = zod.void()
...
export const DeleteClientNutritionGoalResponse = zod.void()
...
export const CreateCoachNoteResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "content": zod.string(),
  "createdAt": zod.coerce.date(),
...
export const DeleteCoachNoteResponse = zod.void()
...
export const CreateCallLogResponse = zod.object({
  "id": zod.number(),
  "clientId": zod.number(),
  "date": zod.coerce.date(),
  "durationMinutes": zod.number().nullish(),
...
export const DeleteCallLogResponse = zod.void()
