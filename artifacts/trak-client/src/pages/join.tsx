    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center pb-2">
          <div className="text-3xl font-black text-violet-600 mb-2">TrakAI</div>
          <CardTitle className="text-xl">Welcome to TrakAI</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 text-center">
          <p className="text-muted-foreground">
            Your coach has invited you to join TrakAI. You'll be able to log workouts, track your progress, and stay connected.
          </p>
